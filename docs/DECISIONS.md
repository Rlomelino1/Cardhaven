...
- Kept the 3-copy limit scoped to the main deck, matching the pre-existing check; rejected expanding it to main+sideboard combined in this pass — that is a separate zone-scope rules question the handoff didn't raise.
